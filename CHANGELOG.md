...
* switch context bar to braille dots (⣿) with dim inactive field ([f29e7f2](https://github.com/claude-contrib/claude-status/commit/f29e7f2d2693c759ff21df97e9f577725b84b4ad))
